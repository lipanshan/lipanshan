...
function first(preP,preC,VeryHuo,selectP,selectC)
{
    ...
    cityareaname[0]=new Array('东城区', '西城区', '海淀区', '朝阳区', '丰台区', '石景山区', '通州区', '顺义区',
                              '房山区', '大兴区', '昌平区', '怀柔区', '平谷区', '门头沟区', '延庆县', '密云县');
    if (selectP=='02')
...
function selectcityarea(preP,preC,VeryHuo)
{
   ...
   if(preP == 'registPro'){
        ...
        $('#lcpregistPro').val('00');
        $('#lcpregistCity').html('');
        $('#lcpregistCity').val('00');
   }
   if(preP=='contactsPro'){
         $('#lcpcontactsPro').html('');
        $('#lcpcontactsPro').val('00');
        $('#lcpcontactsCity').html('');
        $('#lcpcontactsCity').val('00');
   }
   if(preP=='openedBankPro'){
        $('#lcpopenedBankPro').html('');
        $('#lcpopenedBankPro').val('00');
        $('#lcpopenedBankCity').html('');
        $('#lcpopenedBankCity').val('00');
   }
