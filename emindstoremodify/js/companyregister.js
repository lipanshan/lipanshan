$(function() {
   ...
   // 上传营业登记证pluload插件
    ...
    selectFn($('#lcpregistPro'),'registPro',creatOption2(cityArr),1,2)();
    selectFn($('#lcpcontactsPro'),'contactsPro',creatOption2(cityArr),1,2)();
    selectFn($('#lcpopenedBankPro'),'openedBankPro',creatOption2(cityArr),1,1)();
    ...
    $("#onregist").click(function(){
        ...
        $.ajax({
            ...
            beforeSend: function () {
                // ajax请求前调用，验证输入是否完整/
               if(!($('#lcpaccount').val()&&$('#lcompanyName').val()&&$('#llicenseNum').val()&&$('#lemail').val()&&$('#lcontactMobile').val()&&$('#lqqnum').val()&&$('#lwebsite').val()&&$('#lpayeeName').val()&&$('#lbankName').val()&&$('#lbankAccount').val()&&$('#ltaxNum').val()&&$('#lfinanceContacts').val()&&$('#lfinanceEmail').val()&&$('#lfinanceMobile').val())){
                    if(!($('#lpayeeName').val()&&$('#lbankName').val()&&$('#lbankAccount').val()&&$('#ltaxNum').val()&&$('#lfinanceContacts').val()&&$('#lfinanceEmail').val()&&$('#lfinanceMobile').val())){
